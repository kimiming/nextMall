...
-- CreateIndex
CREATE UNIQUE INDEX "Lottery_phone_key" ON "Lottery"("phone");

-- CreateIndex
CREATE UNIQUE INDEX "Lottery_secret_key" ON "Lottery"("secret");
...
-- AddForeignKey
ALTER TABLE "Prize" ADD CONSTRAINT "Prize_activityId_fkey" FOREIGN KEY ("activityId") REFERENCES "Activity"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
